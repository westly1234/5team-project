...
EXERCISE_DATA = [
    ...
    # --- 가슴 ---
    {'name': '벤치프레스', 'muscle_group': '가슴', 'gif_url': 'https://burnfit.io/wp-content/uploads/2023/11/BP.gif'},
    ...
    {'name': '인클라인 벤치프레스', 'muscle_group': '가슴', 'gif_url': 'https://burnfit.io/wp-content/uploads/2023/11/INC_BB_PRESS.gif'},
    ...
    {'name': '덤벨 로우', 'muscle_group': '등', 'gif_url': 'https://burnfit.io/wp-content/uploads/2023/11/DB_ROW.gif'},
    ...
    {'name': '바벨 로우', 'muscle_group': '등', 'gif_url': 'https://burnfit.io/wp-content/uploads/2023/11/BB_ROW.gif'},
    ...
    {'name': '래터럴 와이드 풀다운', 'muscle_group': '등', 'gif_url': 'https://burnfit.io/wp-content/uploads/2023/11/LAT_WIDE_PULL_DOWN.gif'},
    ...
    # --- 팔 ---
    {'name': '덤벨 컬', 'muscle_group': '팔', 'gif_url': 'https://burnfit.io/wp-content/uploads/2023/11/DB_CURL.gif'},
    ...
    # --- 유산소 ---
    {'name': '트레드밀', 'muscle_group': '유산소', 'gif_url': 'https://burnfit.io/wp-content/uploads/2023/11/TREADMILL.gif'},
